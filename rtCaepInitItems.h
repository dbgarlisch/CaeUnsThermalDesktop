...
#define ID_CaeUnsThermalDesktop  40
{
    ...
    {   PWP_SITE_GROUPNAME,     /* const char *group */
        "Thermal Desktop",             /* const char *name */
        MAKEGUID(ID_CaeUnsThermalDesktop),  /* PWP_UINT32 id */
    ...
    0, //CaeUnsThermalDesktopBCInfo,            /* CAEP_BCINFO* */
    0, //ARRAYSIZE(CaeUnsThermalDesktopBCInfo), /* PWP_UINT32 BCCnt */

    /*== CAEP_VCINFO*    pVCInfo;    -- array of format VCs or NULL */
    /*== PWP_UINT32      VCCnt;      -- # format VCs */
    0, //CaeUnsThermalDesktopVCInfo,            /* CAEP_VCINFO* pVCInfo */
    0, //ARRAYSIZE(CaeUnsThermalDesktopVCInfo), /* PWP_UINT32 VCCnt */

    /*== const char**    pFileExt;   -- array of valid file extensions */
    /*== PWP_UINT32      ExtCnt;     -- # valid file extensions */
    CaeUnsThermalDesktopFileExt,            /* const char **pFileExt */
    ARRAYSIZE(CaeUnsThermalDesktopFileExt), /* PWP_UINT32 ExtCnt */
